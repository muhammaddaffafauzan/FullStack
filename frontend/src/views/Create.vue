  ...
  ...mapActions('users', ['createUsers']),
   async submitUsers(){
    const credentials = {
          ...
          const success = await this.createUsers(credentials);
          if (success) {
